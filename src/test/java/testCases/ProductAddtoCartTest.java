	...
	WebDriver driver;
	 ...
	 private static ExtentHtmlReporter htmlReporter;
	    ...
	    public void setUpReport()
	    {
	        ...
	        htmlReporter.config().setDocumentTitle("Automation Testing on Ecommerce WebApplication-Product Add to Cart Test report");
		    ...
		    public void ProductPrice() throws IOException, InterruptedException {
		        try {
			       ...
			       userLogin.LoginUserClick();
			        ...
			        RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC-0005A-image1.jpg");
		    	...
		    	boolean productPriceDisplay=productcart.ProductPriceDisplay();
		    	 RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0005B-image1.jpg");
		    	...
		    	Thread.sleep(3000);
		    	 productcart.productClick();
			    	...
			    	String expectedProductName=productcart.ProductName();
			    	 RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0005C-image1.jpg");
			    ...
			    public void ProductQuantityChange() throws IOException, InterruptedException {
			        try {
			            ...
			            RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0006A-image1.jpg");
			        	...
			        	/*String actualDisplay ="View cart\n"
			        			+ "2 x “White Solo 2 Wireless” has been added to your cart.";
				    	String AddedItemMessage=productcart.AddedItemMessage();
				    	System.out.println(productcart.AddedItemMessage());
				    	 Assert.assertEquals( AddedItemMessage,actualDisplay);*/
			    	}
			        catch (Exception e)
					{
						e.printStackTrace();
				    ...
				    public void VerifyProductCartPage() throws IOException, InterruptedException {
				        try {
					    	...
					    	Thread.sleep(3000);
					    	 ...
					    	 RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0007B-image1.jpg");
					    ...
					    public void ViewCartPage() throws IOException, InterruptedException {
					        try {
					        	...
					        	RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0008A-image1.jpg");
								...
								for (WebElement webElement : listOfProductName) {
						            String name = webElement.getText();
						             ...
						             RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0008B-image1.jpg");
								...
								for(int i=1; i < size; i++)
						        {
						            ...
						            RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0008C-image"+i+".jpg");
								...
								for (WebElement webElement : productprice) {
						            ...
						            RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0008D-image1.jpg");
					         ...
					         //product subtotal
								...
								for (WebElement webElement : productTotalPrice) {
						            ...
						            RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0008E-image1.jpg");
						        ...
						        {
						            Assert.assertFalse(listOfProductsImages.size() == 0, "Matched"); // Here, the condition is false. So, the test case will be passed by assertion.
						            Assert.assertFalse(listOfProductName.size() == 0, "Matched"); // Here, the condition is false. So, the test case will be passed by assertion.
						            Assert.assertFalse(productprice.size() == 0, "Matched"); // Here, the condition is false. So, the test case will be passed by assertion.
						    ...
						    public void RemoveProduct() throws IOException, InterruptedException {
						        try {
						        	...
						        	RunReports.takeScreenShot(driver, System.getProperty("user.dir") + "/test-output/screenshots/TC0009-image1.jpg");
